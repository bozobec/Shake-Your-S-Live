...
import src.analysis
from components.ClientsideFunctions.ClientsideFunctions import CLIENTSIDE_CALLBACK_SMOOTH_SCROLLING, \
    CLIENTSIDE_CALLBACK_PRICING_DISPLAY, CLIENTSIDE_CALLBACK_SCROLL_CAPTURE
