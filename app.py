...
offcanvas = html.Div(
    [
        ...
        dbc.Offcanvas([
            ...
            dmc.Space(h=10),
            dmc.Text("Key features of the Growth Estimation Tool include:", size="sm"),
            dmc.List([
                dmc.ListItem("Dataset Selection: Easily choose the dataset you want to analyze from the dropdown menu. "
                "The tool supports a wide range of datasets, enabling you to select the one that suits your needs."),
                dmc.ListItem("Historical Data Visualization: Visualize the historical data of your selected dataset, providing "
                ...
                dmc.ListItem("Predictive Analysis: Leverage the advanced predictive capabilities of GROOWT to forecast the "
                "future growth of your dataset."),
                dmc.ListItem("Customization Options: Tailor your analysis by adjusting parameters ""and variables to fine-tune your "
                "predictions. The tool offers flexibility in adapting the analysis to your specific requirements."),
                dmc.ListItem("Decision Support: Use the insights generated by the Growth Estimation Tool to inform your "
            ...
            dmc.Space(h=10),
            dmc.Text("With the Growth Estimation Tool, you can explore the potential future outcomes of your dataset, "
                "helping you make more informed choices and better understand the dynamics of the data"
                " you're working with. Whether you're tracking financial metrics, website traffic, or any other "
...
growth_message = dmc.Alert(
    children=dmc.Text("Promising growth upcoming!"),
    id="growth-message",
    title="Promising growth!",
    color="green"),

# Plateau
plateau_message = dmc.Alert(
    children=dmc.Text("Plateau"),
    id="plateau-message",
    title="Plateau",
    color="blue"),
...
graph_card = dmc.Card(
    children=[
        ...
        html.Div(id='graph-container1',
                 children=[dcc.Graph(id='main-graph1', config={'displayModeBar': False}
                                     )
                           ]
                 )],
    withBorder=True,
